...
class NamespaceManager:
    ...
    def __init__(self):
        ...
        # SHACL Rules vocabulary, SHACL, and SPARQL function namespace
        # (SRL/RDF syntax) — sourced from vocab so the strings live in one place.
        self.register("sh", str(vocab.SH))
        self.register("srl", str(vocab.SRL))
        self.register("sparql", str(vocab.SPARQL))

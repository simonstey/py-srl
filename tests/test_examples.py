...
EXAMPLES = [
    ...
    ("exists-filter", "exists-patterns", "Positive existence check via body triple pattern", "exists-patterns/exists-patterns-001.srl", "exists-patterns/exists-patterns-001.ttl", "OK"),
    ("not-exists-filter", "exists-patterns", "Absence check via NOT negation element", "exists-patterns/exists-patterns-002.srl", "exists-patterns/exists-patterns-002.ttl", "OK"),
    ("exists-complex", "exists-patterns", "Existence check with multiple conditions", "exists-patterns/exists-patterns-003.srl", "exists-patterns/exists-patterns-003.ttl", "OK"),
    ...
    ("derived-identifiers", "hash-functions", "Derive normalized ids and fingerprints via string builtins", "hash-functions/hash-functions-001.srl", "hash-functions/hash-functions-001.ttl", "OK"),
